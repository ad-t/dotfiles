...
--  },
...

  {
    ...
    config = function()
      vim.keymap.set('n', '<leader><space>', ':Neotree toggle<cr>', { desc = '[ ] Toggle NeoTree' })
    end
  },
    ...
    config = function()
      require("gruvbox").setup({
        ...
        overrides = {
          ...
          DiagnosticSignHint = { fg = "#7FA2AC", bg = "None" },
          TabLine = { bg = "#504945"},
          TabLineSel = { fg = "#0D0E0F", bg = "#98971A" },
          TabLineFill = { bg = "#32302F" },
        },
        dim_inactive = false,
...
require('fzf-lua').setup({
  'default',
  files =  {
    cmd = 'ag --nocolor --hidden --ignore="node_modules" --ignore=".git" -g "."',
